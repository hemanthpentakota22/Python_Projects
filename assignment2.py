'''Programming Assignment 17th JanA positive integer N is given.
 ...
 Write a function:def solution(N)that, given a positive integer N, returns the highest power of 2 that divides N.
